...
public class B22Box extends JFrame{
	...
	public B22Box() {
		...
		addWindowFocusListener(new WindowFocusListener() {
			...
			public void windowLostFocus(WindowEvent arg0) {
				...
				savePensionDates();
				try {
					txt.savePaycheckArray("C:/Users/Gaming/Desktop/paychecks.txt", paychecks);
...
//		JPanel main = new JPanel();
	...
	public void loadFromHash(){
		...
		for(int i =0; i < 1000; i++){	
			if(bk.vars.get("otherSources"+Integer.toString(i)) != null){ 
				otherSources.add(bk.vars.get("otherSources"+Integer.toString(i)));
			}
			if(bk.vars.get("otherAmounts"+Integer.toString(i)) != null){ 
				otherAmounts.add(bk.vars.get("otherAmounts"+Integer.toString(i)));
			}
			if(bk.vars.get("alimonyAmounts "+Integer.toString(i)) != null){ 
				alimonyAmounts .add(bk.vars.get("alimonyAmounts"+Integer.toString(i)));
			}
			if(bk.vars.get("alimonyDates"+Integer.toString(i)) != null){ 
				alimonyDates.add(bk.vars.get("alimonyDates"+Integer.toString(i)));
			}
			if(bk.vars.get("regularPaymentsAmounts"+Integer.toString(i)) != null){ 
				regularPaymentsAmounts.add(bk.vars.get("regularPaymentsAmounts"+Integer.toString(i)));
			}
			if(bk.vars.get("regularPaymentsSources"+Integer.toString(i)) != null){ 
				regularPaymentsSources.add(bk.vars.get("regularPaymentsSources"+Integer.toString(i)));
			}
			if(bk.vars.get("regularPaymentsDates"+Integer.toString(i)) != null){ 
				regularPaymentsDates.add(bk.vars.get("regularPaymentsDates"+Integer.toString(i)));
			}	
			if(bk.vars.get("businessNames"+Integer.toString(i)) != null){ 
				businessNames.add(bk.vars.get("businessNames"+Integer.toString(i)));
			}
			if(bk.vars.get("businessAmounts"+Integer.toString(i)) != null){ 
				businessAmounts.add(bk.vars.get("businessAmounts"+Integer.toString(i)));
			}
			if(bk.vars.get("businessDates"+Integer.toString(i)) != null){ 
				businessDates.add(bk.vars.get("businessDates"+Integer.toString(i)));
			}
			if(bk.vars.get("realAmounts"+Integer.toString(i)) != null){ 
				realAmounts.add(bk.vars.get("realAmounts"+Integer.toString(i)));
			} 
			if(bk.vars.get("realDates"+Integer.toString(i)) != null){ 
				realDates.add(bk.vars.get("realDates"+Integer.toString(i)));
			}
			if(bk.vars.get("interestAmounts"+Integer.toString(i)) != null){ 
				interestAmounts.add(bk.vars.get("interestAmounts"+Integer.toString(i)));
			}
			if(bk.vars.get("interestDates"+Integer.toString(i)) != null){ 
				interestDates.add(bk.vars.get("interestDates"+Integer.toString(i)));
			}
			if(bk.vars.get("unemploymentAmounts"+Integer.toString(i)) != null){ 
				unemploymentAmounts.add(bk.vars.get("unemploymentAmounts"+Integer.toString(i)));
			}
			if(bk.vars.get("unemploymentDates"+Integer.toString(i)) != null){ 
				unemploymentDates.add(bk.vars.get("unemploymentDates"+Integer.toString(i)));
			}
			if(bk.vars.get("pensionAmounts"+Integer.toString(i)) != null){ 
				pensionAmounts.add(bk.vars.get("pensionAmounts"+Integer.toString(i)));
			}
			if(bk.vars.get("pensionDates"+Integer.toString(i)) != null){ 
				pensionDates.add(bk.vars.get("pensionDates"+Integer.toString(i)));
			}
	...
	public void saveToHash(){
		BkFile bk = new BkFile();
		for(int i = 0; i < 1000; i ++){
			bk.vars.remove("otherSources"+Integer.toString(i));
			bk.vars.remove("otherAmounts"+Integer.toString(i));
			bk.vars.remove("alimonyAmounts"+Integer.toString(i));
			bk.vars.remove("alimonyDates"+Integer.toString(i));
			bk.vars.remove("regularPaymentsAmounts"+Integer.toString(i));
			bk.vars.remove("regularPaymentsSources"+Integer.toString(i));
			bk.vars.remove("regularPaymentsDates"+Integer.toString(i));
			bk.vars.remove("businessNames"+Integer.toString(i));
			bk.vars.remove("businessAmounts"+Integer.toString(i));
			bk.vars.remove("realAmounts"+Integer.toString(i));
			bk.vars.remove("realDates"+Integer.toString(i));
			bk.vars.remove("interestAmounts"+Integer.toString(i));
			bk.vars.remove("interestDates"+Integer.toString(i));
			bk.vars.remove("unemploymentAmounts"+Integer.toString(i));
			bk.vars.remove("unemploymentDates"+Integer.toString(i));
			bk.vars.remove("pensionAmounts"+Integer.toString(i));
			bk.vars.remove("pensionDates"+Integer.toString(i));
		}
		for(int i =0; i < otherSources.size(); i++){	
			bk.setVar("otherSources"+Integer.toString(i), otherSources.get(i)); 
		}
		for(int i =0; i < otherAmounts.size(); i++){	
			bk.setVar("otherAmounts"+Integer.toString(i), otherAmounts.get(i)); 
		}
		for(int i =0; i < alimonyAmounts.size(); i++){	
			bk.setVar("alimonyAmounts"+Integer.toString(i), alimonyAmounts.get(i)); 
		}
		for(int i =0; i < alimonyDates.size(); i++){	
			bk.setVar("alimonyDates"+Integer.toString(i), alimonyDates.get(i)); 
		}
		for(int i =0; i < regularPaymentsAmounts.size(); i++){	
			bk.setVar("regularPaymentsAmounts"+Integer.toString(i), regularPaymentsAmounts.get(i)); 
		}	 
		for(int i =0; i < regularPaymentsSources.size(); i++){	
			bk.setVar("regularPaymentsSources"+Integer.toString(i), regularPaymentsSources.get(i)); 
		}	 	
		for(int i =0; i < regularPaymentsDates.size(); i++){	
			bk.setVar("regularPaymentsDates"+Integer.toString(i), regularPaymentsDates.get(i)); 
		}	 	 
		for(int i =0; i < businessNames.size(); i++){	
			bk.setVar("businessNames"+Integer.toString(i), businessNames.get(i)); 
		}	
		for(int i =0; i < businessAmounts.size(); i++){	
			bk.setVar("businessAmounts"+Integer.toString(i), businessAmounts.get(i)); 
		}			
		for(int i =0; i < realAmounts.size(); i++){	
			bk.setVar("realAmounts"+Integer.toString(i), realAmounts.get(i)); 
		}
		for(int i =0; i < realDates.size(); i++){	
			bk.setVar("realDates"+Integer.toString(i), realDates.get(i)); 
		}
		for(int i =0; i < interestAmounts.size(); i++){	
			bk.setVar("interestAmounts"+Integer.toString(i), interestAmounts.get(i)); 
		}
		for(int i =0; i < interestDates.size(); i++){	
			bk.setVar("interestDates"+Integer.toString(i), interestDates.get(i)); 
		}
		for(int i =0; i < unemploymentAmounts.size(); i++){	
			bk.setVar("unemploymentAmounts"+Integer.toString(i), unemploymentAmounts.get(i)); 
		}
		for(int i =0; i < unemploymentDates.size(); i++){	
			bk.setVar("unemploymentDates"+Integer.toString(i), unemploymentDates.get(i)); 
		}
		for(int i =0; i < pensionAmounts.size(); i++){	
			bk.setVar("pensionAmounts"+Integer.toString(i), pensionAmounts.get(i)); 
		}
		for(int i =0; i < pensionDates.size(); i++){	
			bk.setVar("pensionDates"+Integer.toString(i), pensionDates.get(i)); 
		}	
	}
